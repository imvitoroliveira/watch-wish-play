...
const LEAGUE_IDS = {
  SERIE_A: 71, SERIE_B: 72, SERIE_C: 75,
  COPA_DO_BRASIL: 73, COPA_NORDESTE: 475, FEMININO: 606, SUPERCOPA: 625,
  CARIOCA: 352, PAULISTA: 480,
  LIBERTADORES: 13, SULAMERICANA: 11, RECOPA_SULAMERICANA: 535,
  ELIMINATORIAS: 34, AMISTOSOS: 10,
  LA_LIGA: 140, BUNDESLIGA: 78, SERIE_A_ITALIA: 135, LIGUE_1: 61,
...
const LEAGUE_PRIORITY = [
  ...
  LEAGUE_IDS.LA_LIGA, LEAGUE_IDS.BUNDESLIGA, LEAGUE_IDS.SERIE_A_ITALIA, LEAGUE_IDS.LIGUE_1,
  LEAGUE_IDS.EUROPA_LEAGUE,
  LEAGUE_IDS.SERIE_B, LEAGUE_IDS.CARIOCA, LEAGUE_IDS.PAULISTA,
  LEAGUE_IDS.COPA_NORDESTE, LEAGUE_IDS.FEMININO, LEAGUE_IDS.SUPERCOPA,
  LEAGUE_IDS.SERIE_C, LEAGUE_IDS.AMISTOSOS,
];
