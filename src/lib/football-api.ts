...
const LEAGUE_IDS = {
  ...
  LA_LIGA: 140, BUNDESLIGA: 78, SERIE_A_ITALIA: 135,
...
const LEAGUE_PRIORITY = [
  ...
  LEAGUE_IDS.LA_LIGA, LEAGUE_IDS.BUNDESLIGA, LEAGUE_IDS.SERIE_A_ITALIA,
  LEAGUE_IDS.EUROPA_LEAGUE, LEAGUE_IDS.SUPERCOPA,
