...
const TEST_SUITE: TestCase[] = [
  ...
  { name: "client-login: SQL injection no username", category: "security", fn: "client-login", method: "POST", body: { action: "login", username: "' OR 1=1 --", password: "test" }, expect: { status: [200, 400, 403], hasKey: "success" } },
