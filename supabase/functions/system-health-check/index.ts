...
const TEST_SUITE: TestCase[] = [
  ...
  { name: "client-login: input malicioso no username", category: "security", fn: "client-login", method: "POST", body: { action: "login", username: "admin<script>alert(1)</script>", password: "test" }, expect: { status: [400], hasKey: "success" } },
